      ...
      <div className="absolute inset-0 z-20 flex flex-col p-4 pointer-events-none">
        <div className="flex justify-between items-center mb-4 pointer-events-auto">
          <div className="flex items-center">
            <Button variant="outline" className="border-[#00D1FF]/30 text-[#00D1FF] hover:bg-[#00D1FF]/10 hover:border-[#00D1FF]/50 bg-[#1A1A1F]/40 backdrop-blur-md mr-2 transition-all duration-300 shadow-lg shadow-[#0B0B0F]/50">
              <Plus className="mr-2 h-4 w-4" />
              New Strategy
            </Button>
            <Button variant="outline" className="border-[#00D1FF]/30 text-[#00D1FF] hover:bg-[#00D1FF]/10 hover:border-[#00D1FF]/50 bg-[#1A1A1F]/40 backdrop-blur-md transition-all duration-300 shadow-lg shadow-[#0B0B0F]/50">
              <Save className="mr-2 h-4 w-4" />
              Save
            </Button>
          </div>
          <div className="flex items-center">
            <Button className="bg-[#1A1A1F]/40 backdrop-blur-md border border-[#00D1FF]/30 text-[#00D1FF] hover:bg-[#00D1FF]/10 hover:border-[#00D1FF]/50 font-bold mr-2 transition-all duration-300 shadow-lg shadow-[#0B0B0F]/50">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
          <TabsList className="grid w-full grid-cols-3 bg-[#1A1A1F]/40 backdrop-blur-md border border-[#00D1FF]/30 pointer-events-auto rounded-2xl p-1">
            <TabsTrigger value="builder" className="data-[state=active]:bg-[#00D1FF]/10 data-[state=active]:text-[#00D1FF] data-[state=active]:border-[#00D1FF]/30 rounded-xl transition-all duration-300">
              Strategy Builder
            </TabsTrigger>
            <TabsTrigger value="code" className="data-[state=active]:bg-[#00D1FF]/10 data-[state=active]:text-[#00D1FF] data-[state=active]:border-[#00D1FF]/30 rounded-xl transition-all duration-300">
              Code View
            </TabsTrigger>
            <TabsTrigger value="settings" className="data-[state=active]:bg-[#00D1FF]/10 data-[state=active]:text-[#00D1FF]/30 rounded-xl transition-all duration-300">
              Settings
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="builder" className="flex-1 flex mt-4">
            ...
            <div className="flex-1 bg-black/80 border-teal-500/30 backdrop-blur-md rounded-lg p-4 pointer-events-auto">
              <div className="flex justify-between items-center mb-4">
                ...
                <Button variant="outline" size="sm" className="border-[#00D1FF]/30 text-[#00D1FF] hover:bg-[#00D1FF]/10 hover:border-[#00D1FF]/50 bg-[#1A1A1F]/40 backdrop-blur-md transition-all duration-300 shadow-lg shadow-[#0B0B0F]/50">
              ...
              <div className="h-[calc(100%-40px)] bg-gray-900/50 rounded-lg border border-gray-800 flex items-center justify-center">
                <div className="text-gray-400 text-center">
                  ...
                  <Button variant="outline" className="mt-2 border-[#00D1FF]/30 text-[#00D1FF] hover:bg-[#00D1FF]/10 hover:border-[#00D1FF]/50 bg-[#1A1A1F]/40 backdrop-blur-md transition-all duration-300 shadow-lg shadow-[#0B0B0F]/50">
                    <Plus className="mr-2 h-4 w-4" />
                    Start from Template
                  </Button>
                </div>
            ...
            <div className="bg-black/80 border-teal-500/30 backdrop-blur-md rounded-lg p-4 h-full pointer-events-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-300 block mb-2">Strategy Period</label>
              ...
              <div className="mt-6">
                <Button variant="primary" className="font-bold">Save Settings</Button>
              </div>
            </div>
          </TabsContent>
        </Tabs>
