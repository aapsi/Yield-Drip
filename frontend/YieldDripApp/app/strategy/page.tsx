          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-black/80 border-teal-500/30 backdrop-blur-md pointer-events-auto">
              ...
              <CardContent>
                ...
                <Button
                  className="mt-4 bg-[#1A1A1F]/40 backdrop-blur-md border border-[#00D1FF]/30 text-[#00D1FF] hover:bg-[#00D1FF]/10 hover:border-[#00D1FF]/50 font-bold transition-all duration-300 shadow-lg shadow-[#0B0B0F]/50"
